...
export class TaskVariableService extends BaseService {
  constructor(
  ...
  getTaskVariables$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskVariableService.GetTaskVariablesPath, 'get');
    if (params) {
  ...
  modifyTaskVariables$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskVariableService.ModifyTaskVariablesPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
  ...
  getTaskVariable$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskVariableService.GetTaskVariablePath, 'get');
    if (params) {
      rb.path('id', params.id, {});
  ...
  putTaskVariable$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskVariableService.PutTaskVariablePath, 'put');
    if (params) {
      rb.path('id', params.id, {});
      rb.path('varName', params.varName, {});
      rb.body(params.body, 'application/json');
  ...
  deleteTaskVariable$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskVariableService.DeleteTaskVariablePath, 'delete');
    if (params) {
      rb.path('id', params.id, {});
      rb.path('varName', params.varName, {});
    }
  ...
  getTaskVariableBinary$Any$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskVariableService.GetTaskVariableBinaryPath, 'get');
    if (params) {
      rb.path('id', params.id, {});
      rb.path('varName', params.varName, {});
    }
  ...
  setBinaryTaskVariable$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskVariableService.SetBinaryTaskVariablePath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.path('varName', params.varName, {});

...
export class TaskLocalVariableService extends BaseService {
  constructor(
  ...
  getTaskLocalVariables$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskLocalVariableService.GetTaskLocalVariablesPath, 'get');
    if (params) {
  ...
  modifyTaskLocalVariables$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskLocalVariableService.ModifyTaskLocalVariablesPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
  ...
  getTaskLocalVariable$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskLocalVariableService.GetTaskLocalVariablePath, 'get');
    if (params) {
      rb.path('id', params.id, {});
  ...
  putTaskLocalVariable$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskLocalVariableService.PutTaskLocalVariablePath, 'put');
    if (params) {
      rb.path('id', params.id, {});
      rb.path('varName', params.varName, {});
      rb.body(params.body, 'application/json');
  ...
  deleteTaskLocalVariable$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskLocalVariableService.DeleteTaskLocalVariablePath, 'delete');
    if (params) {
      rb.path('id', params.id, {});
      rb.path('varName', params.varName, {});
    }
  ...
  getTaskLocalVariableBinary$Any$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskLocalVariableService.GetTaskLocalVariableBinaryPath, 'get');
    if (params) {
      rb.path('id', params.id, {});
      rb.path('varName', params.varName, {});
    }
  ...
  setBinaryTaskLocalVariable$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskLocalVariableService.SetBinaryTaskLocalVariablePath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.path('varName', params.varName, {});

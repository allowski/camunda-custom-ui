...
import { CompleteTaskDto } from '../models/complete-task-dto';
import { CountResultDto } from '../models/count-result-dto';
import { FormDto } from '../models/form-dto';
import { TaskBpmnErrorDto } from '../models/task-bpmn-error-dto';
import { TaskDto } from '../models/task-dto';
import { TaskEscalationDto } from '../models/task-escalation-dto';
import { TaskQueryDto } from '../models/task-query-dto';
...
export class TaskService extends BaseService {
  ...
  getTasks$Response(params?: {
     ...
     */
    maxResults?: number;
  }): Observable<StrictHttpResponse<Array<TaskDto>>> {
  ...
  getTasks(params?: {
    ...
    return this.getTasks$Response(params).pipe(
      map((r: StrictHttpResponse<Array<TaskDto>>) => r.body as Array<TaskDto>)
    );
  }
  ...
  queryTasks$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.QueryTasksPath, 'post');
    if (params) {
      rb.query('firstResult', params.firstResult, {});
      rb.query('maxResults', params.maxResults, {});
  ...
  getTasksCount$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.GetTasksCountPath, 'get');
    if (params) {
      rb.query('processInstanceId', params.processInstanceId, {});
      rb.query('processInstanceIdIn', params.processInstanceIdIn, {});
      rb.query('processInstanceBusinessKey', params.processInstanceBusinessKey, {});
  ...
  queryTasksCount$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.QueryTasksCountPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  createTask$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.CreateTaskPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  getTask$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.GetTaskPath, 'get');
    if (params) {
  ...
  setAssignee$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.SetAssigneePath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  handleBpmnError$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.HandleBpmnErrorPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  handleEscalation$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.HandleEscalationPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  claim$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.ClaimPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  complete$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.CompletePath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  delegateTask$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.DelegateTaskPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  getDeployedForm$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.GetDeployedFormPath, 'get');
    if (params) {
      rb.path('id', params.id, {});
    }
  ...
  getForm$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.GetFormPath, 'get');
    if (params) {
      rb.path('id', params.id, {});
    }
  ...
  getFormVariables$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.GetFormVariablesPath, 'get');
    if (params) {
      rb.path('id', params.id, {});
  ...
  getRenderedForm$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.GetRenderedFormPath, 'get');
    if (params) {
      rb.path('id', params.id, {});
    }
  ...
  resolve$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.ResolvePath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  submit$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.SubmitPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  unclaim$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, TaskService.UnclaimPath, 'post');
    if (params) {
      rb.path('id', params.id, {});
    }

...
export interface TaskQueryDto {
   ...
   */
  sorting?: Array<{ 'sortBy'?: 'instanceId' | 'caseInstanceId' | 'dueDate' | 'executionId' | 'caseExecutionId' | 'assignee' | 'created' | 'description' | 'id' | 'name' | 'nameCaseInsensitive' | 'priority' | 'processVariable' | 'executionVariable' | 'taskVariable' | 'caseExecutionVariable' | 'caseInstanceVariable', 'sortOrder'?: 'asc' | 'desc', 'parameters'?: SortTaskQueryParametersDto }>;
